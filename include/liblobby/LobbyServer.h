...
protected:
    ...
    virtual void OnNMSLobbyLogin(unsigned id, unsigned revision, const std::string& user, const std::string& pass,
                                 const std::string& version);
    /// Lobby-Register-Nachricht.
    virtual void OnNMSLobbyRegister(unsigned id, unsigned revision, const std::string& user, const std::string& pass,
    ...
    virtual void OnNMSLobbyServerUpdatePlayer(unsigned id, unsigned curplayer, unsigned maxplayer);
